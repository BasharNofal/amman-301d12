...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: because using let when defining a variable makes it block scoped variable which means that it can't be seen outside of that block
  console.log(viewed);
